  ...
  return (
    <div className={styles.footer_container}>
      ...
      <div className={styles.social_container}>
        <a href="https://twitter.com/AlchemyNitt" target="_blank">
          <svg
            viewBox="0 0 24 24"
            width="288"
            height="288"
        ...
        <a href="https://www.facebook.com/alchemy.nitt" target="_blank">
          <svg
            width="288"
            height="288"
            viewBox="0 0 48 48"
        ...
        <a
          href="https://www.linkedin.com/company/alchemy-nit-trichy/"
          target="_blank"
        >
          <svg
            preserveAspectRatio="none"
        ...
        <a href="https://www.instagram.com/alchemy_nitt/" target="_blank">
          <svg
            preserveAspectRatio="none"
            viewBox="0 0 18 18"
            width="288"
