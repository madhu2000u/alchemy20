...
const userSchema = new mongoose.Schema({
	...
	alc_id: {type: String, required: true, unique:true}, //TODO change required and unique to true.They are changed to false for testing google oauth function as it was showing E11000 duplicate key error (MongoError)
